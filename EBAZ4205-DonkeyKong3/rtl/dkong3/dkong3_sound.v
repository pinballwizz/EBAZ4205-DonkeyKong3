...
SUB1_ROM sub1rom(I_SUBCLK, W_SUB1_ADDR[12:0], 1'b0, W_SUB1ROM_OEn, W_SUB1ROM_DO); //, I_CLK_24M, I_DLADDR, I_DLDATA, I_DLWR);
...
// ~phi2 not working as chip enable
SUB2_ROM sub2rom(I_SUBCLK, W_SUB2_ADDR[12:0], 1'b0, W_SUB2ROM_OEn, W_SUB2ROM_DO); //, I_CLK_24M, I_DLADDR, I_DLDATA, I_DLWR);
