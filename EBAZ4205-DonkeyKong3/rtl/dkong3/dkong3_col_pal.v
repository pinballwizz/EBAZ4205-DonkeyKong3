...
CLUT_PROM_512_8 prom1d(I_CLK_24M, W_PAL_AB, W_1D_DO); //, I_DLCLK, I_DLADDR, I_DLDATA, I_DLWR);

CLUT_PROM_512_4 prom1c(I_CLK_24M, W_PAL_AB, W_1C_DO); //, I_DLCLK, I_DLADDR, I_DLDATA, I_DLWR);
