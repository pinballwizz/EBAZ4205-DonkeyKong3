Donkey Kong 3 Arcade for the EBAZ-4205 ZYNQ-7010 FPGA Board. Pinballwiz.org 2026
Code from gaz68.

Notes:
Setup for keyboard controls in Upright mode (5 = Coin) (Start P1 = 1) (Start P2 = 2)(LCtrl = Spray)(Arrow Keys = Move U or D or L or R)
Consult the Docs Folder for Information regarding peripheral connections and schematics.

Build:
* Obtain correct roms file for Donkey Kong 3 (see scripts in tools folder for rom details).
* Unzip rom files to the tools folder.
* Run the make dkong3 proms script in the tools folder.
* Place the generated prom files inside the proms folder.
* Open the EBAZ4205-DonkeyKong3 project file using Vivado (v2022.2 or silimar is recommended)
